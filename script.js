...
class App {
  ...
  _loadMap(position) 
    ...
    console.log(`Your location: https://www.google.com/maps/@${latitude},${longitude}`);
...
L.tileLayer('https://{s}.tile.openstreetmap.fr/hot/{z}/{x}/{y}.png', {
  ...
  _showForm(mapE) {
     console.log(`Current position ${mapE.latlng}`);
        this.#mapEvent = mapE;
  ...
  _newWorkout(e) {
    ...
    return alert('Inputs have to be positive numbers or not empty!');
